...
public class ParameterTest {
    ...
    static class ParameterAspect {
        ...
        @Before("allMember() && this(obj)") //proxy 객체를 obj에 가져온다.
        public void thisArgs(JoinPoint joinPoint, MemberService obj) {
            log.info("[thisArgs]{}, obj={}",joinPoint.getSignature(), obj.getClass());

        }

        @Before("allMember() && target(obj)") //proxy가 호출하는 실제 대상을 obj에 가져온다.
        ...
        public void withinArgs(JoinPoint joinPoint, ClassAop annotation) {
            log.info("[@withinArgs]{}, obj={}",joinPoint.getSignature(), annotation);
